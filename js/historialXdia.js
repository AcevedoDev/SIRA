// Al cargar la página, mostrar el historial del día automáticamente
document.addEventListener('DOMContentLoaded', function() {
    cargarHistorialHoy();
  });
  
  function cargarHistorialHoy() {
    fetch('api_historial_hoy.php')
  ...
  // Redirigir al perfil al hacer clic en un registro (solo en historialXdia)
